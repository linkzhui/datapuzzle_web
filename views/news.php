...
<div class="ui vertical inverted sidebar menu">
  <a class="item home_page">Home</a>
   ...
   <a class="active item news_page">News</a>
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      ...
      <h2>Check the latest new about data puzzle</h2>
  ...
  <div class="ui vertical stripe segment">
    <div class="ui text container">
      ...
      <h4 class="ui horizontal header divider"></h4>
      <h3 class="ui header">v1.2.0</h3>
      <p>Add new feature:</P>
      <p>1. File encryption</p>
      <p>2. File fragment</p>
      
      <h4 class="ui horizontal header divider"></h4>
      <h3 class="ui header">v1.1.0</h3>
      <p>Add new feature:</P>
      <p>1. Google firebase authentication </p>
      <p>2. Google drive file upload</p>
