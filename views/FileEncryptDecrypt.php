...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      <h1 class="ui inverted header">
        About File Encrypt/Decrypt Feature
      </h1>
    </div>
  ...
  <div class="ui vertical stripe segment">
    <div class="ui middle aligned stackable grid container">
      <div class="row">
          <p><b>For the security purpose, we will uses AES(Advanced Encryption Standard) to encrypt the file. If user want to read the original file, we will decrypt the file for the user. The AES require a secret key to encrypt and decrypt the file, we will let user to input the secret key by themselves and let user take the responsibility to keep this secret key safe.</b></p>
      </div>
    </div>
  </div>
