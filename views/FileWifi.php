...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      <h1 class="ui inverted header">
        About File transfer via Wifi Direct Feature
      </h1>
    </div>
  ...
  <div class="ui vertical stripe segment">
    <div class="ui middle aligned stackable grid container">
      <div class="row">
          <p><b>The Android Wifi Direct feature allow us to use this mode to discover nearby peers via wifi direct. Then they can send the file fragment to other peers, in order to let them keep this fragment for user, because those fragment is already decrypted, it is pretty safe to store those fragments into other people's cell phone. In case, you cell phone is lost. You can still capable to recover the original file in other cell phone.</b></p>
      </div>
    </div>
  </div>
