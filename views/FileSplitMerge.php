...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      <h1 class="ui inverted header">
        About File Split/Merge Feature
      </h1>
    </div>
  ...
  <div class="ui vertical stripe segment">
    <div class="ui middle aligned stackable grid container">
      <div class="row">
          <p><b>For the security purpose, the Data Puzzle will split the original file into several file fragments. Then merge the fragments back into one file. If user want to read the original file again.</b></p>
      </div>
    </div>
  </div>
